package com.ybs.pullapidata.msrstnlist;
...
import com.ybs.pullapidata.msrstnlist.ApiConnection;
import com.ybs.pullapidata.msrstnlist.DbConnection;

public class MsrstnList 
{
	static public ApiConnection apiconnection;
	static public String BaseDate, BaseTime;
	static public String tableName = "MSRSTN_LIST";
	...
	public static void main(String[] args) throws IOException, SQLException, ClassNotFoundException 
	{
    	...
    	try {
			apiconnection.setUrl("http://openapi.airkorea.or.kr/openapi/services/rest/MsrstnInfoInqireSvc/getMsrstnList");
